...
function ProductOfCollection({img,price,name,saleprice,AddTocart,id,style,catid,description,refresh}) {
 ...
 navigate("/collections/products/productdetail")
    ...
    return (
      <div
        className={style ? style : "col-xl-4 col-md-6 col-lg-4 col-sm-6 col-6"}
      >
        <div className="product-wrap mb-25 scroll-zoom">
          <div className="product-img">
            <a
              onClick={handleClick}
              href={refresh&&"/collections/products/productdetail" }
            >
            ...
            <div className="product-action">
              ...
              <div className="pro-same-action pro-cart">
                <a
                  title="Add To Cart"
                  onClick={() => AddTocart({ id, img, name, saleprice })}
                >
