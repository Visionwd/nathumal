                   ...
                   <div className="custom-row-4">
                    {
                        this.state.items.map(({item_id,item_name,item_img,item_price,item_saleprice,cat_id})=>{
                            return <Product id={item_id} catid={cat_id} AddTocart={this.AddTocart} key={item_id} name={item_name} img={"https://www.heydemo.ml/nathumalapi/uploads/"+item_img} price={item_price} saleprice={item_saleprice} />
                        })
                    }
                   </div>
                    {/* <OwlCarousel
