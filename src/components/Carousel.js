...
function MyCarousel() {
   ...
   showStatus={false}>
        ...
        <div className="slider-height-7 bg-glaucous d-flex align-items-center"  style={{background:`url(${data.file.childImageSharp.original.src})`, backgroundSize: "cover", backgroundPosition: "center"}}>
