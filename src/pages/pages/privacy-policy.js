          ...
          <div className="row">
            <div className="col-md-12 ">
              <div class="PageContent ">
                <p class="p1">
                  This Privacy Policy (the “Policy”), together with our Terms of
                  Use, Cookies Policy and any other document(s) referred to in
                  them, sets out how we will treat your personal information,
                  and is intended to help you understand how we deal with any
                  personal information we may obtain from you and how you may
                  access, alter, rectify and/or remove it. It is important that
                  you read this Policy so that you are aware of how and why we
                  are using such information.
                </p>
                <p class="p2">
                  <span class="s1">
                    This Policy only relates to the collection, protection,
                    disclosure and use of personal data belonging to individuals
                    who visit www.nathuandghudoo.com (“our Site”) or who
                    otherwise provide us with their personal information. It
                    does not relate to data which emanates from companies or
                    other entities, although the general principles regarding
                    our collection and use of data is broadly the same
                    irrespective of whoever is the user of our website, or our
                    customer. We will use your information only for the purposes
                ...
                <p class="p2">
                  <span class="s1">
                    ...
                    we may collect and use all personal information you provide
                    to us in the ways described in this Policy. If you do not
                    agree with the terms of this Policy, please do not provide
                    personal details to us.
                  </span>
                </p>
                <p class="p2">&nbsp;</p>
                <p class="p3">
                ...
                <p class="p5">
                  ...
                  <span class="s1">
                    our information allows us to curate a personalised
                    experience for you.
                  </span>
                </p>
                <ul class="ul1">
                  <li class="li7">
                    <span class="s2">To improve our website</span>
                  </li>
                </ul>
                <p class="p5">
                  <span class="s3">W</span>
                  <span class="s1">
                    e continually strive to improve our website offerings based
                    on the information and feedback we receive from you.
                  </span>
                </p>
                <ul class="ul1">
                  <li class="li7">
                    <span class="s2">To improve customer service</span>
                  </li>
                </ul>
                <p class="p5">
                  <span class="s3">Y</span>
                  <span class="s1">
                    our information helps us to more effectively respond to your
                ...
                <p class="p5">
                  <span class="s1">
                    We implement numerous security measures to maintain the
                ...
                <p class="p5">
                  <span class="s1">
                    ...
                    social security numbers, financials, etc.) will not be
                ...
                <p class="p5">
                  <span class="s1">
                    ...
                    capture and retain certain information.
                  </span>
                </p>
                <p class="p4">
                ...
                <p class="p4">
                  If you prefer, you can choose to have your computer warn you
                  each time a cookie is being sent, or you can choose to turn
                ...
                <p class="p2">
                  <span class="s1">
                    Please note that we may need to update this Policy from time
                    to time to reflect changes in the law. Any changes we may
                    make to our Policy in the future will be posted on this page
                    and, where appropriate, notified to you by e-mail. We
                    recommend that you check this page regularly to ensure that
                    you have read the most recent version and are happy with any
                    changes.
                  </span>
                </p>
                ...
                <p class="p9">
                  <span class="s1">www.nathuandghudoo.com</span>
                </p>
                <p class="p1">+91 73031-00009</p>
                <p>
                  <a
                    style={{ color: "gray", textDecoration: "none" }}
                    href="mailto:consumerservices@nathuandghudoo.com"
                  >
                ...
                <p>
                  ...
                  >
                    https://www.instagram.com/nathumalandghudoomal/
                  </a>
                </p>
                ...
                <p>
                  ...
                  >
                    https://www.facebook.com/nmgmludhiana/
                  </a>
                </p>
